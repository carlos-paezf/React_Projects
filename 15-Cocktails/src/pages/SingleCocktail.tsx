...
import { ICocktailDetail } from "../interfaces";
import { Loading } from "../components/Loading";


export const SingleCocktail: FC = () => {
    const { id } = useParams();
    ...
    useEffect( () => {
        ...
        async function getCocktail () {
            try {
                ...
                if ( !data.drinks ) return setCocktail( null );
            ...
            <div className="drink">
                ...
                <div className="drink-info">
                    ...
                    <p>
                        ...
                        { ingredients.map( ( item, index ) => item && <span key={ index }> { item }</span> ) }
                    </p>
                </div>
            </div>
        </section>
